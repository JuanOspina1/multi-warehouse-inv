...
export function AuthContextProvider({ children }) {
  ...
  function signUp(email, password, firstName, lastName, officeAddress, officePhone) {
  ...
  return (
    <AuthContext.Provider value={{ signUp, logIn, logOut, user, userInformation, authState }}>
      {children}
